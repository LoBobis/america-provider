...
// +kubebuilder:resource:scope=Namespaced,categories={crossplane,provider,america}
...
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:printcolumn:name="SECRET-NAME",type="string",JSONPath=".spec.credentials.secretRef.name",priority=1
// +kubebuilder:resource:scope=Cluster,categories={crossplane,provider,america}
// A ClusterProviderConfig configures a America provider.
